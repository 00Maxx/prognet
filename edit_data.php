<?php
    include "koneksi.php";
    $id = $_GET['nim'];
    $ambilData = mysqli_query($koneksi, "SELECT * FROM tblmhs WHERE nim='$id'");
...
<div class="card-body">
    ...
    <input type="number" name="nim" value="<?php echo $data['nim']?>"class="form-control col-md-9" placeholder="Masukkan NIM">
    </div>
...
<?php
    ...
    if(isset($_POST['simpan']))
    {
        ...
        mysqli_query($koneksi, "UPDATE tblmhs 
            SET nim='$NIM,', nama='$NAMA', tempat_lahir='$TEMPAT_LAHIR', tanggal_lahir='$TANGGAL_LAHIR', jenis_kelamin='$JENIS_KELAMIN', alamat='$ALAMAT', kodepos='$KODE_POS'
            WHERE nim='$id'") or die(mysqli_error($koneksi));
            
        echo "<div align='center'><h5> Silahkan Tunggu, Data Sedang DiUpdate....</h5></div>";
        echo "<meta http-equiv='refresh' content='1;url=http://prognet.localnet/public/data_mahasiswa.php'>";
    }
